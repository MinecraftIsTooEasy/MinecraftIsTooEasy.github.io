(function () {
    ...
    const translations = {
        zh: {
            ...
            what_is_modded_mite_desc: "Modded MITE 通常指安装了以 FishModLoader 为主的模组加载器的 MITE 实例，也可以指围绕 MITE 模组开发、文档和社区维护形成的协作社区。",
            community_invite: "模组开发、网站维护、文档编写和社区运营都需要贡献者。可通过关于页面中的渠道联系我们。",
            quick_nav: "快速导航",
            mod_intro: "模组介绍",
            ...
            resource_packs: "资源包",
            resource_pack_desc_html: "MITE 默认识别名为 <strong>MITE Resource Pack 1.6.4</strong> 的文件夹或 ZIP。安装 <a href=\"https://github.com/MinecraftIsTooEasy/BetterGameSetting\">Better Game Setting</a> 后可以在游戏内自由切换资源包。",
            ...
            mods: "模组",
            mods_desc_html: "绝大多数 MITE 模组通过 <a href=\"https://github.com/XiaoYuOvO/FishModLoader\">FishModLoader</a> 加载，简称 FML。",
            ...
            page_description_development: "FishModLoader、ManyLib 与锈铁核心开发文档。",
            ...
            fml_intro_html: "MITE 模组通过 <a href=\"https://github.com/XiaoYuOvO/FishModLoader\">FishModLoader</a> 加载，简称 FML。3.0.0 之前采用较接近 Forge 的开发方式，3.0.0 起重构为更接近 Fabric 的加载器。",
            fml_comparison: "版本对比",
            fml_version: "版本",
            mappings: "映射",
            ...
            legacy: "历史生态",
            active: "持续发展",
            fml_recommendation: "新项目应优先选择 FML3。需要开发指导时，可通过关于页面联系社区。",
            page_title_fml3: "FML3 模组目录 - Modded MITE",
            page_description_fml3: "社区维护的 FML3 模组历史目录。",
            fml3_heading: "FML3 模组目录",
            fml3_notice: "此表是站内历史目录；最新整理结果请以社区维护的在线目录为准。点击列标题可按该列排序。",
            ...
            fml1_archive: "FML1 是旧版加载器生态，现有项目可能仍依赖它，但新开发工作建议使用 FML3。旧模组资料尚未形成完整站内目录。",
            fml1_next_html: "可先查看 <a href=\"about-fml.html\">FML 版本对比</a>，或前往 <a href=\"https://www.kdocs.cn/l/cabc4n66CYbJ\">社区模组目录</a> 查找现有项目。",
            page_title_pack_usage: "资源包安装 - Modded MITE",
            page_description_pack_usage: "MITE 原版及 Better Game Setting 环境下的资源包安装步骤。",
            pack_usage_heading: "资源包安装方法",
            without_bgs: "未安装 Better Game Setting",
            with_bgs: "已安装 Better Game Setting",
            pack_step_extensions: "确认系统已显示文件扩展名，避免把文件误命名为 .zip.zip。",
            pack_step_download: "下载所需资源包。",
            pack_step_rename: "将资源包重命名为 MITE Resource Pack 1.6.4.zip。",
            pack_step_move: "把 ZIP 放入 MITE 游戏目录的 .minecraft/resourcepacks/ 文件夹。",
            pack_step_launch: "启动 MITE；能够正常进入游戏即表示安装成功。",
            pack_step_bgs_move: "把下载的 ZIP 直接放入 .minecraft/resourcepacks/ 文件夹，无需重命名。",
            pack_step_bgs_select: "启动游戏，在“游戏设置 → 资源包”中选择刚放入的资源包。",
            page_title_contact: "关于社区 - Modded MITE",
            page_description_contact: "Modded MITE 社区的联系渠道与协作入口。",
            contact_heading: "关于 Modded MITE 社区",
            contact_intro: "社区由 MITE 玩家和开发者共同维护，主要工作包括模组开发、兼容测试、资源整理与文档维护。",
            contact_channels: "联系与参与",
            contact_github: "在 GitHub 查看项目、提交问题或参与开发。",
            contact_qq: "加入 QQ 群 661223990，咨询游戏、模组和开发问题。",
            contact_contribute: "提交网站改进时，请附上清晰的复现步骤、来源链接或内容依据。",
        ...
        en: {
            ...
            component_load_error: "A shared page component failed to load. Please refresh and try again.",
            page_title_home: "Modded MITE",
            page_description_home: "Mods, resources, and development documentation from the Modded MITE community.",
            what_is_modded_mite: "What is Modded MITE?",
            what_is_modded_mite_desc: "Modded MITE usually means a MITE installation using a mod loader, primarily FishModLoader. It also refers to the community that collaborates on MITE mods, documentation, and maintenance.",
            community_invite: "Contributors are welcome across mod development, website maintenance, documentation, and community operations. See the About page for contact channels.",
            ...
            page_description_resources: "MITE resource packs, mod catalogs, and community bundles.",
            resources_heading: "Resources",
            resource_packs: "Resource packs",
            resource_pack_desc_html: "MITE normally recognizes a folder or ZIP named <strong>MITE Resource Pack 1.6.4</strong>. With <a href=\"https://github.com/MinecraftIsTooEasy/BetterGameSetting\">Better Game Setting</a>, packs can be switched in game.",
            download_resource_pack: "Download a pack below if your game is missing one:",
            ...
            mods: "Mods",
            mods_desc_html: "Most MITE mods are loaded with <a href=\"https://github.com/XiaoYuOvO/FishModLoader\">FishModLoader</a>, commonly shortened to FML.",
            ...
            page_description_tutorials: "Player tutorials and development entry points for Modded MITE.",
            ...
            fml3_setup_desc: "Set up Java 17, IDEA, and an FML3 development environment.",
            dev_docs_desc: "Browse development references for ManyLib, Rusted Iron Core, and more.",
            page_title_development: "Development docs - Modded MITE",
            page_description_development: "Development documentation for FishModLoader, ManyLib, and Rusted Iron Core.",
            ...
            document_chinese_only: "The document body is currently available in Chinese only.",
            copy_code: "Copy code",
            copied: "Copied",
            ...
            page_description_fml: "FishModLoader versions and development environment comparison.",
            fml_intro_html: "MITE mods are loaded through <a href=\"https://github.com/XiaoYuOvO/FishModLoader\">FishModLoader</a>, or FML. Versions before 3.0.0 used a Forge-like development model; version 3.0.0 introduced a loader closer to Fabric.",
            ...
            fml_recommendation: "New projects should prefer FML3. Contact the community through the About page for development guidance.",
            page_title_fml3: "FML3 mod catalog - Modded MITE",
            page_description_fml3: "A community-maintained historical catalog of FML3 mods.",
            fml3_heading: "FML3 mod catalog",
            fml3_notice: "This table is a historical on-site catalog. Refer to the community-maintained online catalog for the latest list. Select a column heading to sort it.",
            mod_table_caption: "FML3 mods with dependencies, runtime side, and project links",
            ...
            page_description_fml1: "Legacy FML1 mod ecosystem and migration guidance.",
            fml1_heading: "FML1 mod notes",
            fml1_archive: "FML1 is the legacy loader ecosystem. Existing projects may still depend on it, but new development should use FML3. A complete on-site catalog of legacy mods is not yet available.",
            fml1_next_html: "Start with the <a href=\"about-fml.html\">FML version comparison</a>, or search the <a href=\"https://www.kdocs.cn/l/cabc4n66CYbJ\">community mod catalog</a> for existing projects.",
            page_title_pack_usage: "Resource pack installation - Modded MITE",
            page_description_pack_usage: "Install MITE resource packs with or without Better Game Setting.",
            pack_usage_heading: "Resource pack installation",
            without_bgs: "Without Better Game Setting",
            with_bgs: "With Better Game Setting",
            pack_step_extensions: "Make sure file extensions are visible so the pack is not accidentally named .zip.zip.",
            pack_step_download: "Download the resource pack you need.",
            pack_step_rename: "Rename it to MITE Resource Pack 1.6.4.zip.",
            pack_step_move: "Move the ZIP into .minecraft/resourcepacks/ inside the MITE game directory.",
            pack_step_launch: "Launch MITE. Reaching the game successfully confirms the installation.",
            pack_step_bgs_move: "Move the downloaded ZIP directly into .minecraft/resourcepacks/ without renaming it.",
            pack_step_bgs_select: "Launch the game and select the pack under Game Settings → Resource Packs.",
            page_title_contact: "About the community - Modded MITE",
            page_description_contact: "Contact channels and contribution entry points for the Modded MITE community.",
            contact_heading: "About the Modded MITE community",
            contact_intro: "The community is maintained by MITE players and developers working on mods, compatibility testing, resource curation, and documentation.",
            contact_channels: "Contact and contribute",
            contact_github: "Browse projects, report issues, or contribute through GitHub.",
            contact_qq: "Join QQ group 661223990 for game, mod, and development questions.",
            contact_contribute: "When proposing a website change, include clear reproduction steps, source links, or supporting evidence.",
            template_heading: "Page title",
            template_content: "Page content",
            page_title_404: "Page not found - Modded MITE",
            not_found_message: "The requested page could not be found. It may have moved or been removed.",
